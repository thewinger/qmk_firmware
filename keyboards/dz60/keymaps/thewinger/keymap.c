...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_WIN] = LAYOUT_all(
        ...
        KC_LCTL,  KC_LGUI,  KC_LALT,                     KC_SPC,                    _LEDS,     RALT_T(KC_LEFT),    RGUI_T(KC_DOWN),    RCTL_T(KC_RIGHT)),
    ...
    [_MAC] = LAYOUT_all(
        ...
        KC_LSFT,            KC_Z,   KC_X,   KC_C,   KC_V,   KC_B,   KC_N,   KC_M,   KC_COMM,    KC_DOT, KC_SLSH,    RSFT_T(KC_UP),
        KC_LCTL,  KC_LALT,  KC_LGUI,                     KC_SPC,                    _FUNC2,     RALT_T(KC_LEFT),    RGUI_T(KC_DOWN),    RCTL_T(KC_RIGHT)),
    ...
    [_LEDS] = LAYOUT_all(
        ...
        _______, _______, _WIN, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, _MAC, _______, _______, _______, _______, _______, _______, _______, _______, _______,  _______,    _______,
        _______, _______, _______,  _______,    _______, _______, _______, _______, _______, _______, _______,  _______,
        _______, _______, _______,                      _______,                    _______, _______,           _______,             _______)
